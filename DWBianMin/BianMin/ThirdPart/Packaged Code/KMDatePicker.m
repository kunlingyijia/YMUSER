...
#define kMinuteCountOfEveryHour 2
...
- (void)loadData {
    ...
    // 分
    _mArrMinute = [NSMutableArray arrayWithObjects:@"00",@"30", nil];
...
- (void)drawRect:(CGRect)rect {
    ...
    [btnCancel setTitleColor:[UIColor colorWithHexString:kNavigationBgColor] forState:UIControlStateNormal];
    ...
    if ([self canShowScrollToNowButton]) {
        ...
        [btnScrollToNow setTitleColor:[UIColor colorWithHexString:kNavigationBgColor] forState:UIControlStateNormal];
    ...
    [btnConfirm setTitleColor:[UIColor colorWithHexString:kNavigationBgColor] forState:UIControlStateNormal];
